package com.zpedroo.farmaxe.utils.formula;

import java.util.HashMap;
import java.util.Map;

import static com.zpedroo.farmaxe.utils.config.ExperienceFormula.BASE_EXP;
import static com.zpedroo.farmaxe.utils.config.ExperienceFormula.EXPONENT;
